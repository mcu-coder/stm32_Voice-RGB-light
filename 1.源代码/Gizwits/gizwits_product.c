...
int8_t gizwitsEventProcess(eventInfo_t *info, uint8_t *gizdata, uint32_t len)
{
    ...
    for(i=0; i<info->num; i++)
    {
        ...
        case EVENT_timing:
            ...
            Sensorthreshold.timing = currentDataPoint.valuetiming;
			valueFlashflag = 1;
            break;
        case EVENT_LEDMode:
            currentDataPoint.valueLEDMode = dataPointPtr->valueLEDMode;
            GIZWITS_LOG("Evt: EVENT_LEDMode %d\n", currentDataPoint.valueLEDMode);
            switch(currentDataPoint.valueLEDMode)
            {
            case LEDMode_VALUE0:
                //user handle
                ...
                break;
            case LEDMode_VALUE1:
                ledLightColour = WARM_LIGHT;
                break;
            case LEDMode_VALUE2:
                ledLightColour = NEUTRAL_LIGHT;
                break;
            default:
                break;
            }
...
void userInit(void)
{
    ...
    /*
    currentDataPoint.valueModel = ;
    currentDataPoint.valuebody_recognition = ;
    currentDataPoint.valuetiming = ;
    currentDataPoint.valueLEDMode = ;
